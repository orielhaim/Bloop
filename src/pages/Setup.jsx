...
import { activateNumber, issueNumber } from '../services/api';
import {
  generateKeys,
  importVaultExport,
  setupVault,
...
export default function Setup({ onComplete }) {
  ...
  const handleImport = () => {
    ...
    const requiresPassword =
      importData?.mode === 'password' || importData?.encrypted;
    ...
    startTransition(async () => {
      ...
      try {
        await importVaultExport(
          importData,
          requiresPassword ? importPassword : null,
        );
        if (onComplete) onComplete();
        else navigate('/');
      } catch (e) {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-base-content/60">
                  Create your secure calling identity.
                </div>
              </div>
            </div>
          ...
          <div className="card-body gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-base-content/60">
                  Restore your secure identity from a file.
                </div>
              </div>
            </div>
        ...
        <div className="card-body gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-base-content/60">
                Choose how your vault unlocks.
              </div>
            </div>
          </div>
          <div className="grid gap-4">
            <label
              className={`card border ${mode === 'silent' ? 'border-primary' : 'border-base-200'} bg-base-100 shadow-sm cursor-pointer`}
            >
              <div className="card-body flex-row items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-base-content/60">
                    Unlocks automatically on trusted devices. Quick access,
                    lower protection.
                  </div>
                </div>
              </div>
            ...
            <label
              className={`card border ${mode === 'password' ? 'border-primary' : 'border-base-200'} bg-base-100 shadow-sm cursor-pointer`}
            >
              <div className="card-body flex-row items-start gap-4">
                <input
                  type="radio"
                ...
                <div>
                  ...
                  <div className="text-xs text-base-content/60">
                    Requires a password to unlock your vault. Stronger
                    protection.
                  </div>
                </div>
              </div>
