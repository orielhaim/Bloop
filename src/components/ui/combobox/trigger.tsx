...
export function ComboboxTrigger({ children, className }: ComboboxTriggerProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "relative z-20 flex h-10 w-full min-w-52 cursor-text items-center justify-between gap-3 rounded-xl border border-border bg-transparent px-3 text-sm text-foreground",
